...
$(function(){
    /*갤러리버튼 안사라지게*/
    $(".variable button").click(function(){
        $(this).css({
        "display": "block", "background": "#000", "color": "#fff"
        })
    })
    /*영화수록곡 주의사항*/
    $(".col-lg-7>.section-title>h2 img").hover(
        function(){
            $(".music_text").stop().fadeIn();
            
        },
        function(){
            $(".music_text").stop().fadeOut();
        })
    /*추천음악*/
    $(".recom_music").click(function(){
        $(".recom_music_at").addClass("art");
    })
    $(".recom_music_at span").click(function(){
        $(".recom_music_at").removeClass("art");
    })
})
